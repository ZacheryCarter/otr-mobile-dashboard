...
# Password Creation/Validation Logic
    ...
    password_creation = password  # Replaced input() with function parameters (password in validate_new_signup_login) so Tkinter Entry values are passed in from .get
